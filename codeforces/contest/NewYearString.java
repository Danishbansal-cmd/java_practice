...
// choose a character in the string 𝑠
//  and replace it with 0, 2, 5, or 6 (you can choose any one of these four characters).
// Calculate the minimum number of operations needed to make the string 𝑠
//  a New Year string.
...
//  (4≤𝑛≤20
// ) — the number of characters in 𝑠
// ;
// the second line contains 𝑠
//  — a sequence of 𝑛
//  characters 0, 2, 5, and/or 6.
// Output
// For each test case, output one integer — the minimum number of operations needed to make the string 𝑠
//  a New Year string.
...
public class NewYearString {
    public static void main(String[] args) {
        ...
        while (intputNumber-- > 0) {
            ...
            System.out.println(newYearString(length, s));
        }

        sc.close(); // Close the Scanner to free resources
    }

    static int newYearString(int length, String s){
