...
// Paul and Mary want to learn by themselves how to find a wonderful coloring of the string. But they are very young, so they need a hint. Help them find 𝑘
...
// Each test case consists of one non-empty string 𝑠
//  which consists of lowercase letters of the Latin alphabet. The number of characters in the string doesn't exceed 50
// .

// Output
// For each test case, output a separate line containing one non-negative integer 𝑘
